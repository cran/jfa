...
public:
  ~model_pp_taint() {}
  model_pp_taint(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_pp_taint_namespace::model_pp_taint";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      current_statement__ = 44;
      stan::math::check_less_or_equal(function__, "t", t, 1);
      ...
      stan::math::validate_non_negative_index("kappa_s", "S", S);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
    num_params_r__ = 1 + 1 + 1 + 1 + S + S;
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_pp_taint_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      auto nu =
        in__.template read_constrain_lb<local_scalar_t__, jacobian__>(1,
          lp__);
          ...
          jacobian__>(1, lp__, S);
      {
        ...
        lp_accum__.add(stan::math::normal_lpdf<propto__>(kappa_s, mu, sigma));
        current_statement__ = 38;
        if (use_likelihood) {
          current_statement__ = 36;
          lp_accum__.add(stan::math::beta_proportion_lpdf<propto__>(t,
                           stan::model::rvalue(theta_s, "theta_s",
                             stan::model::index_multi(s)),
                           stan::model::rvalue(kappa_s, "kappa_s",
                             stan::model::index_multi(s))));
        }
      }
    } catch (const std::exception& e) {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    (void) jacobian__;
    static constexpr const char* function__ =
      "model_pp_taint_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      current_statement__ = 1;
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      Eigen::Matrix<local_scalar_t__,-1,1> kappa_s =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(S, DUMMY_VAR__);
      current_statement__ = 6;
      stan::model::assign(kappa_s,
        in__.read<Eigen::Matrix<local_scalar_t__,-1,1>>(S),
        "assigning variable kappa_s");
      out__.write_free_lb(1, kappa_s);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  }
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      current_statement__ = 6;
      context__.validate_dims("parameter initialization", "kappa_s",
        "double", std::vector<size_t>{static_cast<size_t>(S)});
        ...
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(S, DUMMY_VAR__);
      {
        ...
        current_statement__ = 6;
        kappa_s_flat__ = context__.vals_r("kappa_s");
        pos__ = 1;
        for (int sym1__ = 1; sym1__ <= S; ++sym1__) {
          stan::model::assign(kappa_s, kappa_s_flat__[(pos__ - 1)],
            "assigning variable kappa_s", stan::model::index_uni(sym1__));
          pos__ = (pos__ + 1);
        }
      }
      out__.write_free_lb(1, kappa_s);
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"phi", "nu", "mu", "sigma", "theta_s",
                "kappa_s"};
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    for (int sym1__ = 1; sym1__ <= S; ++sym1__) {
      param_names__.emplace_back(std::string() + "kappa_s" + '.' +
        std::to_string(sym1__));
    }
    if (emit_transformed_parameters__) {}
    if (emit_generated_quantities__) {}
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"theta_s\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(S) + "},\"block\":\"parameters\"},{\"name\":\"kappa_s\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(S) + "},\"block\":\"parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = 1 + 1 + 1 + 1 + S + S;
