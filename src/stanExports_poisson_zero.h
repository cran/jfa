...
static constexpr std::array<const char*, 66> locations_array__ =
  ...
  " (in 'poisson_zero', line 26, column 8 to column 9)",
  " (in 'poisson_zero', line 26, column 2 to column 26)",
  ...
  " (in 'poisson_zero', line 43, column 8 to column 18)",
  " (in 'poisson_zero', line 43, column 2 to column 45)",
  ...
  " (in 'poisson_zero', line 17, column 31 to line 22, column 3)"};
template <typename T0__,
          stan::require_all_t<stan::is_std_vector<T0__>,
                              std::is_integral<std::decay_t<stan::value_type_t<T0__>>>>* = nullptr>
      ...
      auto p_error =
        in__.template read_constrain_lub<local_scalar_t__,
          jacobian__>(stan::model::rvalue(
                        ...
                        "FnMakeRowVec__((uniform_prior ? alpha : promote(0, real, data)))",
                        stan::model::index_uni(1)),
          stan::model::rvalue(
            (Eigen::Matrix<double,1,-1>(1) << (uniform_prior ? beta : 1)).finished(),
            "FnMakeRowVec__((uniform_prior ? beta : promote(1, real, data)))",
            stan::model::index_uni(1)), lp__);
      current_statement__ = 2;
      auto lambda =
        in__.template read_constrain_lub<local_scalar_t__, jacobian__>(0, (B
          / N), lp__);
