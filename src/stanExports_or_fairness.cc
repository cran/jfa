...
#include "stanExports_or_fairness.h"

RCPP_MODULE(stan_fit4or_fairness_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_or_fairness")
